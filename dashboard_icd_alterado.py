...
dados = pd.read_excel('resultados.xlsx')
...
fig_kmeans2 = px.choropleth_mapbox(
    ...
    color='grupo_k2',
    hover_data={'cidades': True, 'idhm_renda': True,'alta_tecnologia': True, 'media_alta_tecnologia': True, 'media_tecnologia': True, 'media_baixa_tecnologia': True},
